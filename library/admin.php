...
function bones_login_css() {
	wp_enqueue_style( 'bones_login_css', get_current_revision(get_template_directory_uri() . '/library/css/login.css', false ));
}
...
function bones_custom_admin_footer() {
	_e( '<span id="footer-thankyou">Developed by <a href="http://www.aioros.net" target="_blank">Aioros</a></span> Built using <a href="http://themble.com/bones" target="_blank">Bones</a>.', 'bonestheme' );
}
